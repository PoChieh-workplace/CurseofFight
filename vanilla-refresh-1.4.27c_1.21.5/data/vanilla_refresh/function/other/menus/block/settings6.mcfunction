...
execute if data storage vanilla_refresh_config:config config{cake:1} run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hover_event":{"action":"show_text","value":[{"translate":"Dropping a firework item on a cake will turn it into a party cake that'll explode with confetti when broken or eaten\nCandles can be safely placed on them"}]}},{"translate":"Party Cake: ","color":"gray"},{"translate":"Enabled","color":"green","underlined":true,"hover_event":{"action":"show_text","value":[{"translate":"Click to change this setting"}]},"click_event":{"action":"run_command","command":"/function vanilla_refresh:other/actions/block/cake_disable"}}]
execute if data storage vanilla_refresh_config:config config{cake:0} run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hover_event":{"action":"show_text","value":[{"translate":"Dropping a firework item on a cake will turn it into a party cake that'll explode with confetti when broken or eaten\nCandles can be safely placed on them"}]}},{"translate":"Party Cake: ","color":"gray"},{"translate":"Disabled","color":"red","underlined":true,"hover_event":{"action":"show_text","value":[{"translate":"Click to change this setting"}]},"click_event":{"action":"run_command","command":"/function vanilla_refresh:other/actions/block/cake_enable"}}]

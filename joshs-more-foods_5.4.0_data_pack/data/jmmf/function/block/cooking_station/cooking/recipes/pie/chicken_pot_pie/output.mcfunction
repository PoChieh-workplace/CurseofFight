...
execute if score @s jmmf.count.7 matches 0 run item replace block ~ ~ ~ container.16 with pumpkin_pie
execute if score @s jmmf.count.7 matches 0 run item modify block ~ ~ ~ container.16 jmmf:pie/chicken_pot_pie

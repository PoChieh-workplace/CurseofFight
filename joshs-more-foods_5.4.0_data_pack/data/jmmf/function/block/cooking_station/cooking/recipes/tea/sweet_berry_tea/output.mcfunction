...
execute if score @s jmmf.count.7 matches 0 run item replace block ~ ~ ~ container.16 with minecraft:cookie
execute if score @s jmmf.count.7 matches 0 run item modify block ~ ~ ~ container.16 jmmf:tea/sweet_berry_tea

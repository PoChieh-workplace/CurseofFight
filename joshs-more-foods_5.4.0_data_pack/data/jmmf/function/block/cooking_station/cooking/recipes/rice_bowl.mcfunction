...
execute store success score jmmf:recipe_validation jmmf.data if data storage jmmf:cooking_station {output:{components:{"minecraft:custom_data":{smithed:{id:"jmmf:rice_bowl"}}}}}
...
execute if score @s jmmf.count.7 matches 0 run item modify block ~ ~ ~ container.16 jmmf:rice_bowl

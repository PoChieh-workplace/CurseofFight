...
execute if score jmmf:temp2 jmmf.data matches 0 store result score jmmf:temp_count jmmf.data run data get storage jmmf:cooking_station input.ingredients[4].count
execute if score jmmf:temp2 jmmf.data matches 0 run scoreboard players add jmmf:temp_count jmmf.data 1
execute if score jmmf:temp2 jmmf.data matches 0 store result storage jmmf:cooking_station input.ingredients[4].count int 1 run scoreboard players get jmmf:temp_count jmmf.data

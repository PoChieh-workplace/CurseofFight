...
$tellraw @s [{"translate": "   -> ","color": "gray"},{"translate":"Block ID","color":"#5ba3f5","underlined":true,"hover_event":{"action":"show_text","value":[{"text":"Block ID: "},{"entity":"@n[type=block_display,tag=refresh_CIE2]","nbt":"block_state.Name","color":"yellow"},{"translate":"\nClick to modify"}]},"click_event":{"action":"suggest_command","command":"/function vanilla_refresh:wand/z/display/block/set/item {e:\"block\",at:\"n\",id:\"$(name)\"}"}},{"translate": "   -> ","color": "gray"},{"translate":"Scale","color":"#5ba3f5","underlined":true,"hover_event":{"action":"show_text","value":[{"text":"Scale: "},{"entity":"@n[type=block_display,tag=refresh_CIE2]","nbt":"transformation.scale[0]","color":"yellow"},{"translate":"\nClick to modify"}]},"click_event":{"action":"suggest_command","command":"/function vanilla_refresh:wand/z/display/item/set/scale {e:\"block\",at:\"n\",value:$(scale)}"}},{"translate": "   -> ","color": "gray"},{"translate":"Brightness","color":"#5ba3f5","underlined":true,"hover_event":{"action":"show_text","value":[{"text":"Brightness: "},{"entity":"@n[type=block_display,tag=refresh_CIE2]","nbt":"brightness.block","color":"yellow"},{"translate":"\nClick to modify"}]},"click_event":{"action":"suggest_command","command":"/function vanilla_refresh:wand/z/display/item/set/brightness {e:\"block\",at:\"n\",nbt:\"brightness.block\",value:$(brightness)}"}},{"translate": "  -> ","color": "gray"},{"translate":"Billboard","color":"#5ba3f5","underlined":true,"hover_event":{"action":"show_text","value":[{"text":"Billboard: "},{"entity":"@n[type=block_display,tag=refresh_CIE2]","nbt":"billboard","color":"yellow"},{"translate":"\nClick to modify"}]},"click_event":{"action":"run_command","command":"/function vanilla_refresh:wand/z/display/item/set/billboard {e:\"block\",at:\"n\"}"}}]

tellraw @s [{"text": " "}]

$tellraw @s [{"translate": "   -> ","color": "gray"},{"translate":"Block State/Properties","color":"#5ba3f5","underlined":true,"hover_event":{"action":"show_text","value":[{"text":"Block State/Properties: "},{"entity":"@n[type=block_display,tag=refresh_CIE2]","nbt":"block_state.Properties","interpret":true,"color":"yellow"},{"translate":"\nClick to modify"}]},"click_event":{"action":"suggest_command","command":"/function vanilla_refresh:wand/z/display/block/set/nbt {e:\"block\",at:\"n\",value:$(properties)}"}},{"translate": "   -> ","color": "gray"},{"translate":"Stretch Scale","color":"#5ba3f5","underlined":true,"hover_event":{"action":"show_text","value":[{"text":"Stretch Scale: "},{"entity":"@n[type=block_display,tag=refresh_CIE2]","nbt":"transformation.scale","color":"yellow"},{"translate":"\nClick to modify"}]},"click_event":{"action":"suggest_command","command":"/function vanilla_refresh:wand/z/display/item/set/stretch_scale {e:\"block\",at:\"n\",value:$(stretch_scale)}"}}]

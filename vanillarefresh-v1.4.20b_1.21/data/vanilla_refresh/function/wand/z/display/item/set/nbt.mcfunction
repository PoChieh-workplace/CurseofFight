...
$execute as @$(at)[type=#vanilla_refresh:displays,tag=refresh_CIE2,distance=..64] run function vanilla_refresh:wand/z/display/item/set_nbt {components:$(components)}

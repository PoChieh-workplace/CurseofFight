...
execute at @s run data modify entity @s data.Dye set value 11
execute at @s run scoreboard players set @s refresh_color 11

kill @e[type=item,nbt={Item:{id:"minecraft:gray_dye",count:1}},distance=..0.5]

...
execute at @s run data modify entity @s data.Dye set value 12
execute at @s run scoreboard players set @s refresh_color 12

kill @e[type=item,nbt={Item:{id:"minecraft:black_dye",count:1}},distance=..0.5]

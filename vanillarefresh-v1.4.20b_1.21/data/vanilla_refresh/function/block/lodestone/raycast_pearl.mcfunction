...
execute unless entity @e[distance=..3,type=marker,tag=refresh_entity_lodestone_teleport] unless score temp refresh_count matches 128.. positioned ^ ^ ^1 run function vanilla_refresh:block/lodestone/raycast_pearl

...
#execute if score blockanims refresh_settings matches 1 if block ~ ~ ~ jukebox{RecordItem:{id:"minecraft:music_disc_ward"}} run particle minecraft:note ~ ~.5 ~ 0.05 0 0 1 0 force @a[distance=..32]
#execute if score blockanims refresh_settings matches 1 if block ~ ~ ~ jukebox{RecordItem:{id:"minecraft:music_disc_blocks"}} run particle minecraft:note ~ ~.5 ~ 0.3 0 0 1 0 force @a[distance=..32]
#execute if score blockanims refresh_settings matches 1 if block ~ ~ ~ jukebox{RecordItem:{id:"minecraft:music_disc_cat"}} run particle minecraft:note ~ ~.5 ~ 0.85 0 0 1 0 force @a[distance=..32]
#execute if score blockanims refresh_settings matches 1 if block ~ ~ ~ jukebox{RecordItem:{id:"minecraft:music_disc_chirp"}} run particle minecraft:note ~ ~.5 ~ 0.19 0 0 1 0 force @a[distance=..32]
#execute if score blockanims refresh_settings matches 1 if block ~ ~ ~ jukebox{RecordItem:{id:"minecraft:music_disc_far"}} run particle minecraft:note ~ ~.5 ~ 0 0 0 1 0 force @a[distance=..32]
#execute if score blockanims refresh_settings matches 1 if block ~ ~ ~ jukebox{RecordItem:{id:"minecraft:music_disc_mall"}} run particle minecraft:note ~ ~.5 ~ 0.48 0 0 1 0 force @a[distance=..32]
#execute if score blockanims refresh_settings matches 1 if block ~ ~ ~ jukebox{RecordItem:{id:"minecraft:music_disc_mellohi"}} run particle minecraft:note ~ ~.5 ~ 0.43 0 0 1 0 force @a[distance=..32]
#execute if score blockanims refresh_settings matches 1 if block ~ ~ ~ jukebox{RecordItem:{id:"minecraft:music_disc_otherside"}} run particle minecraft:note ~ ~.5 ~ 0.82 0 0 1 0 force @a[distance=..32]
#execute if score blockanims refresh_settings matches 1 if block ~ ~ ~ jukebox{RecordItem:{id:"minecraft:music_disc_pigstep"}} run particle minecraft:note ~ ~.5 ~ 0.12 0 0 1 0 force @a[distance=..32]
#execute if score blockanims refresh_settings matches 1 if block ~ ~ ~ jukebox{RecordItem:{id:"minecraft:music_disc_stal"}} run particle note ~ ~1 ~ 1 0 0 9999999 0

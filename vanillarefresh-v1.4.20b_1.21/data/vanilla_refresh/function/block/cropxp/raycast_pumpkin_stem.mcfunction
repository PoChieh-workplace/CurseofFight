...
execute unless score @s refresh_count matches 300.. unless score temp refresh_count matches 100.. positioned ^ ^ ^.05 run function vanilla_refresh:block/cropxp/raycast_pumpkin_stem

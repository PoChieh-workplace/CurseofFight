...
execute positioned ~ ~ ~ if block ~ ~ ~ minecraft:enchanting_table align zyx positioned ~.5 ~.5 ~.5 unless entity @e[distance=..0.01,type=marker,tag=refresh_entity_blockanim_enchanting_table] run function vanilla_refresh:block/block_anims/enchanting_table/place

...
execute unless score playersNetherPortalCreativeDelay refresh_gamerules matches 1 run tellraw @s [{"translate": "","color": "aqua"},{"text":"+ ","bold": true},{"translate":"Nether Portal Creative Travel Delay: "},{"score":{"name": "playersNetherPortalCreativeDelay","objective": "refresh_gamerules"},"color":"#c2c2c2" }]
execute if score playersNetherPortalCreativeDelay refresh_gamerules matches 1 run tellraw @s [{"translate": "   ","color": "gray"},{"translate":"Nether Portal Creative Travel Delay: "},{"score":{"name": "playersNetherPortalCreativeDelay","objective": "refresh_gamerules"},"color":"#c2c2c2" }]

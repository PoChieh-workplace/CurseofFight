...
execute if score @s refresh_daycounter2 matches 40 run title @s actionbar [{"translate": "—" ,"color":"gold"}]
execute if score @s refresh_daycounter2 matches 45 run title @s actionbar [{"translate": "——","color":"gold"}]
execute if score @s refresh_daycounter2 matches 70 run title @s actionbar [{"translate": "— —","color":"gold"}]
execute if score @s refresh_daycounter2 matches 75 run title @s actionbar [{"translate": "— D —","color":"gold"}]
execute if score @s refresh_daycounter2 matches 80 run title @s actionbar [{"translate": "— DA —","color":"gold"}]
execute if score @s refresh_daycounter2 matches 85 run title @s actionbar [{"translate": "— DAY —","color":"gold"}]
execute if score @s refresh_daycounter2 matches 100..140 run title @s actionbar [{"translate": "— DAY ","color":"gold"},{"score":{"name":"day","objective": "refresh_daycounter"},"color":"gold"},{"translate": " —","color":"gold"}]

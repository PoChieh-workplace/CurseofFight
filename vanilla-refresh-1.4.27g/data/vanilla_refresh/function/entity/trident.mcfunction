execute as @s[predicate=vanilla_refresh:position/overworld,predicate=vanilla_refresh:position/y-80] if data entity @s Owner run data modify entity @s DealtDamage set value 1b

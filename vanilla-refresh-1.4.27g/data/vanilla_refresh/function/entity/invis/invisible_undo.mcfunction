...
#uses of potion (10)
    ...
    execute if score temp_invis_uses refresh_storage matches 1.. at @s run summon item ~ ~ ~ {PickupDelay:10s,Motion:[0.0,0.1,0.0],Item:{id:"minecraft:splash_potion",count:1,components:{"minecraft:potion_contents":{potion:"minecraft:water"},"minecraft:custom_data":{"VanillaRefreshInvis":10}}},Tags:["refresh_invis_potion_item"]}

execute if score @s gamerules matches -2147483648..1 run function vanilla_refresh:other_features/gamerules/menu

execute if score @s gamerules matches 2..10 run function vanilla_refresh:other_features/gamerules/menu

execute if score @s gamerules matches 11 run function vanilla_refresh:other_features/gamerules/mc/1
execute if score @s gamerules matches 12 run function vanilla_refresh:other_features/gamerules/mc/2
execute if score @s gamerules matches 13 run function vanilla_refresh:other_features/gamerules/mc/3
execute if score @s gamerules matches 14 run function vanilla_refresh:other_features/gamerules/mc/4
execute if score @s gamerules matches 15 run function vanilla_refresh:other_features/gamerules/mc/5
...
execute if score @s gamerules matches 24 run function vanilla_refresh:other_features/gamerules/refresh/4

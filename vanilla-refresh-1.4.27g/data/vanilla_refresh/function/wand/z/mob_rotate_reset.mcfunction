...
$execute as @n[tag=!refresh_temp_usingwand,tag=!refresh_exclude_wand,type=$(wand_mob_filter),distance=..1] at @s run function vanilla_refresh:wand/z/mob_rotate_reset_end

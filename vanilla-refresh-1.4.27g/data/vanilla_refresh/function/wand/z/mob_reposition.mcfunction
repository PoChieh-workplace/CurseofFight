...
$execute unless block ^ ^ ^1 #vanilla_refresh:permeable_wand as @e[tag=!refresh_temp_usingwand,tag=!refresh_exclude_wand,type=$(wand_mob_filter),distance=..8,sort=nearest,limit=1] align y run function vanilla_refresh:wand/z/mob_reposition_set

...
#void
execute as @s[predicate=vanilla_refresh:position/overworld] as @s[predicate=vanilla_refresh:position/y-80] at @a run function vanilla_refresh:death/sound/void

...
#######################
# 初始保護頭盔
item replace entity @a[team=!black] armor.head with minecraft:iron_helmet[  \
    minecraft:enchantments={                                                \
        "cursefight:generic/curse/tick_breaking":2,                         \
        "cursefight:generic/armor/high_land_breath":2,                      \

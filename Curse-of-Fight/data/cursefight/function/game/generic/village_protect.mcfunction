...
tellraw @s {"text":"","color":"white","bold":false,"extra":[{"text":"Curse of Fight >>> ","color":"#CA8EFF"},{"text":"你開啟了結界","color":"gold"},{"text":"，增加 50 點村民友好值","color":"gold"}]}
scoreboard players add @s village_friendly 50

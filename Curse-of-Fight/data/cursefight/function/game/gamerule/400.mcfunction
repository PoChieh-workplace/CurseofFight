...
tellraw @s ["",{"text":"   "},{"text":"最大血量","color":"gray"},{"text":"：","color":"gray"},{"score":{"name":"#cursefight.temp1","objective":"cursefight_temp"},"color":"green"},{"text":"   "},{"text":"跳躍強度","color":"gray"},{"text":"：","color":"gray"},{"score":{"name":"#cursefight.temp2","objective":"cursefight_temp"},"color":"green"},{"text":"   "},{"text":"幸運值","color":"gray"},{"text":"：","color":"gray"},{"score":{"name":"#cursefight.temp3","objective":"cursefight_temp"},"color":"green"}]

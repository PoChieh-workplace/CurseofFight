...
tellraw @s [""]
execute unless score @s cursefight.gamerule.player_info.tips matches 1 run tellraw @s ["",{"text":"          ","color":"gold"},{"text":"\uF001","font":"cursefight:icon","color":"white"},{"text":"【遊戲提示】","color":"blue","hover_event":{"action":"show_text","value": {"text":"遊戲進行期間每三分鐘會播報一次遊戲提示","color":"white"}}},{"text":"：","color":"gray"},{"text":"【 關 】","color":"red","click_event":{"action":"run_command","command":"/trigger cursefight.gamerule.cursefight set 201"},"hover_event":{"action":"show_text","value": {"text":"點擊開啟","color":"green"}}}]
execute if score @s cursefight.gamerule.player_info.tips matches 1 run tellraw @s ["",{"text":"          ","color":"gold"},{"text":"\uF001","font":"cursefight:icon","color":"white"},{"text":"【遊戲提示】","color":"blue","hover_event":{"action":"show_text","value": {"text":"遊戲進行期間每三分鐘會播報一次遊戲提示","color":"white"}}},{"text":"：","color":"gray"},{"text":"【 開 】","color":"green","click_event":{"action":"run_command","command":"/trigger cursefight.gamerule.cursefight set 202"},"hover_event":{"action":"show_text","value": {"text":"點擊關閉","color":"red"}}}]
tellraw @s [""]

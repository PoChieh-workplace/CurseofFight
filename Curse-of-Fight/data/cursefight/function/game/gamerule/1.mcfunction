...
tellraw @s [""]
tellraw @s ["",{"text":"          ","color":"gold"},{"text":"【說明書】","color":"blue","click_event":{"action":"run_command","command":"/trigger cursefight.gamerule.cursefight set 100"},"hoverEvent":{"action":"show_text","value": {"text":"索取各種遊戲說明書","color":"white"}}},{"text":"    ","color":"gold"},{"text":"【Cof 設定】","color":"blue","click_event":{"action":"run_command","command":"/trigger cursefight.gamerule.cursefight set 200"},"hoverEvent":{"action":"show_text","value": {"text":"設定遊戲進行時的各類提示","color":"white"}}}]
tellraw @s ["",{"text":"          ","color":"gold"},{"text":"【遊戲資訊】","color":"blue","click_event":{"action":"run_command","command":"/trigger cursefight.gamerule.cursefight set 300"},"hoverEvent":{"action":"show_text","value": {"text":"查看已知的公共資訊","color":"white"}}},{"text":"    ","color":"gold"},{"text":"【狀態顯示】","color":"blue","click_event":{"action":"run_command","command":"/trigger cursefight.gamerule.cursefight set 400"},"hoverEvent":{"action":"show_text","value": {"text":"設定遊戲進行時的各類提示","color":"white"}}}]

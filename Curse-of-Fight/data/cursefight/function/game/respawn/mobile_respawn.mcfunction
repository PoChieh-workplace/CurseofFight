...
execute if entity @s[predicate=cursefight:player/can_see_sky,gamemode=survival] run summon armor_stand ~ ~ ~ {Tags:[respawn_beacon],Invisible:1b,Invulnerable:1b,Small:1b,NoGravity:1b}

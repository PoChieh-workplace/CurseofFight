...
execute if entity @s[tag=can_use_mob_protection_spell] if score @s cursefight_mob_spell_tick matches 95 unless entity @e[tag=boss_protection,distance=..20] if predicate cursefight:chance/5 at @s run function cursefight:mob/skills/2/spawn_mob

...
scoreboard players operation cursefight_airdrop_range_x cursefight_temp /= const2 X
scoreboard players operation cursefight_airdrop_range_z cursefight_temp /= const2 X

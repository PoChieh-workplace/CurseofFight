...
execute if score cursefight_activity_tick X matches 1 run bossbar set minecraft:cursefight.activity.run max 3600
...
execute if score cursefight_activity_tick X matches 1..3600 as @e[type=minecraft:skeleton,tag=] run function cursefight:activity/random/blood_moon/ske
execute if score cursefight_activity_tick X matches 1..3600 as @e[type=minecraft:zombie,tag=] run function cursefight:activity/random/blood_moon/zom
execute if score cursefight_activity_tick X matches 1..3600 as @e[type=minecraft:spider,tag=] run function cursefight:activity/random/blood_moon/spi
execute if score cursefight_activity_tick X matches 1..3600 as @e[type=minecraft:zombie,tag=cursefight.activity.blood_moon.ai] at @s positioned ~ ~1 ~ unless block ^ ^ ^0.8 air run item replace entity @s weapon.mainhand with minecraft:diamond_pickaxe[minecraft:enchantments={"cursefight:generic/pickaxe/mob_mining":3}]
execute if score cursefight_activity_tick X matches 1..3600 as @e[type=minecraft:zombie,tag=cursefight.activity.blood_moon.ai] at @s positioned ~ ~1 ~ unless block ^ ^ ^0.8 air run tag @s add cursefight.activity.blood_moon.ai.using_pickaxe
execute if score cursefight_activity_tick X matches 1..3600 as @e[type=minecraft:zombie,tag=cursefight.activity.blood_moon.ai,tag=cursefight.activity.blood_moon.ai.using_pickaxe] at @s positioned ~ ~1 ~ if block ^ ^ ^0.8 air run loot replace entity @s weapon.mainhand loot cursefight:activity/blood_moon/melee
execute if score cursefight_activity_tick X matches 1..3600 as @e[type=minecraft:zombie,tag=cursefight.activity.blood_moon.ai,tag=cursefight.activity.blood_moon.ai.using_pickaxe] at @s positioned ~ ~1 ~ if block ^ ^ ^0.8 air run tag @s remove cursefight.activity.blood_moon.ai.using_pickaxe


# bossbar_1
execute if score cursefight_activity_tick X matches 1..3600 run scoreboard players set cursefight_activity_sec X 3600
execute if score cursefight_activity_tick X matches 1..3600 run scoreboard players operation cursefight_activity_sec X -= cursefight_activity_tick X
execute if score cursefight_activity_tick X matches 1..3600 store result bossbar minecraft:cursefight.activity.run value run scoreboard players get cursefight_activity_sec X
execute if score cursefight_activity_tick X matches 1..3600 run scoreboard players operation cursefight_activity_sec X /= const20 X
execute if score cursefight_activity_tick X matches 1..3600 run bossbar set minecraft:cursefight.activity.run name ["",{"text":"\u00A78—《 \u00A74\u00A7l血色 \u00A78\u00A7l警戒 \u00A78》— \u00A7r剩餘 \u00A71"},{"score":{"name":"cursefight_activity_sec","objective":"X"}},{"text":" \u00A7r秒"}]
execute if score cursefight_activity_tick X matches 1..3600 store result score cursefight_activity_blood_moon X run time query daytime
execute if score cursefight_activity_tick X matches 1..3600 unless score cursefight_activity_blood_moon X matches 16000..24000 run time add 30t
# effect
execute if score cursefight_activity_tick X matches 1..3600 run effect give @e[type=#cursefight:hostile] minecraft:resistance 20 1 true

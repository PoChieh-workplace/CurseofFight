...
execute if score _activity_choose_ info matches 1 run execute as @n[tag=border_center,type=armor_stand] at @s run function cursefight:activity/airdrop/summon
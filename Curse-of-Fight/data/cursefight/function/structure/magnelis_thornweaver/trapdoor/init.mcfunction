...
execute positioned ~-30 -70 ~-30 at @e[tag=magnelis_thornweaver_temp,type=minecraft:marker,dx=60,dz=60,dy=400] positioned over motion_blocking_no_leaves run place jigsaw cursefight:magnelis_thornweaver/trapdoor cursefight:bottom 1 ~ ~ ~

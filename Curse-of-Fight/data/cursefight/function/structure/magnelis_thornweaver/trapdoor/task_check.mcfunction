...
execute as @e[type=minecraft:marker,tag=magnelis_thornweaver_task_trapdoor,distance=..30] if function cursefight:structure/magnelis_thornweaver/trapdoor/if_same_block run function cursefight:structure/magnelis_thornweaver/trapdoor/task_complete

...
execute if score @s cursefight.object.tick matches 12..160 @a[tag=magnelis_thornweaver_player_complete_anim] run spectate @n[tag=magnelis_thornweaver_complete_ani_point] @s

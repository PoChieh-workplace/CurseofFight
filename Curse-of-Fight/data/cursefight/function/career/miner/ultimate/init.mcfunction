...
execute at @s run summon minecraft:blaze ~ ~5 ~ {CustomName:'[{"text":"土之術核心","color":"gold"}]',Tags:["miner"],NoAI:1b,DeathLootTable:"minecraft:empty",Health:10,attributes:[{id:"max_health",base:10f}]}
...
execute as @s[scores={cursefight.jump_time=5..}] run effect clear @s levitation
execute as @s[scores={cursefight.jump_time=5..}] run tag @s remove boost
execute as @s[scores={cursefight.jump_time=5..}] run scoreboard players set @s cursefight.jump_time 0

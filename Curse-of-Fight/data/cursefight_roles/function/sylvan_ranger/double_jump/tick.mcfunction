...
execute if score @s cursefight.air_crouch matches 3 if predicate cursefight_roles:sylvan_ranger/double_jump run scoreboard players set @s cursefight.air_crouch 4
execute if score @s cursefight.air_crouch matches 0..2 if predicate cursefight_roles:sylvan_ranger/pre_jump run scoreboard players add @s cursefight.air_crouch 1

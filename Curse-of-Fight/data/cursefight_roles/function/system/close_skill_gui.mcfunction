...
execute unless items entity @s hotbar.6 minecraft:air at run item replace block 0 319 0 container.0 from entity @s enderchest.6
execute unless items entity @s hotbar.7 minecraft:air at run item replace block 0 319 0 container.1 from entity @s enderchest.7
execute unless items entity @s hotbar.8 minecraft:air at run item replace block 0 319 0 container.2 from entity @s enderchest.8

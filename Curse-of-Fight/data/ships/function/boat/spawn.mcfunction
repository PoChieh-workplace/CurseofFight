...
execute positioned ~ ~1 ~ unless predicate ships:water at @s align y run summon minecraft:oak_boat ~ ~.5 ~ {Rotation:[0.0F,0.0F],Invulnerable:1b,Tags:["ships.boat"]}
execute positioned ~ ~1 ~ if predicate ships:water at @s align y run summon minecraft:oak_boat ~ ~1.5 ~ {Rotation:[0.0F,0.0F],Invulnerable:1b,Tags:["ships.boat"]}

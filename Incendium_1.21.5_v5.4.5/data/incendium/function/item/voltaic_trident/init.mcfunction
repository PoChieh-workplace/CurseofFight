...
execute store result score @s in.dummy if data entity @s item.components.minecraft:enchantments{channeling:1}
...
data modify entity @s[scores={in.dummy=..0}] Owner set from storage incendium:temp player.UUID

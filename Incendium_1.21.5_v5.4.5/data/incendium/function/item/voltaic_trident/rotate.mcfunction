...
execute as @e[type=area_effect_cloud,tag=in.voltaic_trident,tag=in.rotated] at @s run particle minecraft:dust{color:[0.4, 0.0, 1.0], scale:1.0} ~ ~ ~ 0.25 0.25 0.25 0.022 5 force

...
execute if entity @s[predicate=incendium:random/25,predicate=incendium:holding/scarlet_dagger] anchored eyes positioned ^ ^ ^1 run particle minecraft:dust{color:[1.0, 0.2, 0.0], scale:1.0} ~ ~ ~ 0.6 0.6 0.6 0 2 force

...
summon arrow ~ ~1 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[0.5,-0.1,0.0],NoGravity:true,PierceLevel:1000}
summon arrow ~ ~1 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[-0.5,-0.1,0.0],NoGravity:true,PierceLevel:1000}
summon arrow ~ ~1 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[0.0,-0.1,0.5],NoGravity:true,PierceLevel:1000}
summon arrow ~ ~1 ~ {Tags:["in.inferno_entity", "in.shulker"],Motion:[0.0,-0.1,-0.5],NoGravity:true,PierceLevel:1000}

...
execute at @a[distance=..100,tag=in.survival_player] run summon blaze ~ ~ ~3 {Tags:["in.checked","in.inferno_entity","in.summoned_blaze"],DeathLootTable:"incendium:entity/dune_blaze",CustomName:{translate:"incendium.mob.inferno.minion.name",fallback:"Infernal Minion"}}
execute at @a[distance=..100,tag=in.survival_player] run summon blaze ~ ~ ~-3 {Tags:["in.checked","in.inferno_entity","in.summoned_blaze"],DeathLootTable:"incendium:entity/dune_blaze",CustomName:{translate:"incendium.mob.inferno.minion.name",fallback:"Infernal Minion"}}

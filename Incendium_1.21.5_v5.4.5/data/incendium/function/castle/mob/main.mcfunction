...
item replace entity @s[type=wandering_trader,tag=in.retreat_trader] weapon.mainhand with air 1
item replace entity @s[type=wandering_trader,tag=in.retreat_trader] weapon.offhand with air 1

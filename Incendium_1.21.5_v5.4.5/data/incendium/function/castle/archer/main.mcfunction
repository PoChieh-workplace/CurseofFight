...
execute unless score $near_me in.dummy matches 1 run attribute @s movement_speed base set 0.1
execute if score $near_me in.dummy matches 1 run attribute @s movement_speed base set 0.295

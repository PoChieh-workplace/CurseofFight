...
data modify entity @s equipment.legs set value {count:1b, id:"minecraft:iron_leggings", components:{damage:0}}
data modify entity @s equipment.mainhand set value {count:1b, id:"minecraft:iron_axe", components:{damage:0}}

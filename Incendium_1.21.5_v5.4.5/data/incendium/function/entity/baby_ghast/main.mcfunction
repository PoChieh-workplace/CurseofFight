...
execute as @e[type=ghast,distance=..12] run attribute @s minecraft:follow_range base set 0.0001
...
# visual
particle minecraft:end_rod ~ ~-0.25 ~ 0.2 0.01 0.2 0 1 force
particle minecraft:flame ~ ~0.5 ~ 0.05 0.05 0.05 0 1 force

...
# T0削弱 T3增強
execute as @a[tag=T0] run attribute @s minecraft:generic.movement_speed base set 0.085
...
execute as @a[tag=T3] run attribute @s minecraft:generic.max_health base set 30

# 基本訊息顯示
execute as @a[tag=!1_splatus_actionbar_disabled] run title @s actionbar {"text":"","color":"#CA8EFF","bold":true,"extra":[{"text":"與邊界距離：","color":"blue"},{"text":"("},{"score":{"name":"@s","objective":"posX"}},{"text":","},{"score":{"name":"@s","objective":"posZ"}},{"text":")  "},{"text":"中心座標：","color":"gold"},{"text":"("},{"score":{"name":"_center_","objective":"posX"}},{"text":","},{"score":{"name":"_center_","objective":"posZ"}},{"text":")  "},{"text":"擊殺數：","color":"dark_green"},{"score":{"name":"@s","objective":"kills"}}]}
...
# 獲勝觸發
execute if score 剩餘隊伍 show_info matches ..1 unless entity @a[tag=win] run function cursefight:game/mode/classic/win
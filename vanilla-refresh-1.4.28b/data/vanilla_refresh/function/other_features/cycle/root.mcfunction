...
execute if score cyclestats refresh_count matches 21 if data storage vanilla_refresh_config:config config{stats_member_id:0} run scoreboard players add cyclestats refresh_count 2
...
execute if score cyclestats refresh_count matches 21 run scoreboard objectives setdisplay below_name refresh_memberID

execute if score cyclestats refresh_count matches 23 run scoreboard players set cyclestats refresh_count 0

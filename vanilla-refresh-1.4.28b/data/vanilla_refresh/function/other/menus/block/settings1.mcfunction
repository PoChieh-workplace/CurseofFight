...
execute if data storage vanilla_refresh_config:config config{blockanims:1} run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hover_event":{"action":"show_text","value":[{"translate":"Adds new and more interesting block particles/animations for Enchantment Tables, Dragon Eggs, Beacons, Wither Skeleton Skulls, Jukeboxes and Brewing Stands"},{"text":"\n\nExtra Config IDs: blockanims_jukebox, blockanims_jukebox2, blockanims_jukebox3, blockanims_beacon, blockanims_beacon2, blockanims_witherskull, blockanims_brewing, blockanims_enchant, blockanims_dragonegg",color:"gray"}]}},{"translate":"Improved Block Animations: ","color":"gray"},{"translate":"Enabled","color":"green","underlined":true,"hover_event":{"action":"show_text","value":[{"translate":"Click to change this setting"}]},"click_event":{"action":"run_command","command":"/function vanilla_refresh:other/actions/block/blockanims_disable"}}]
execute if data storage vanilla_refresh_config:config config{blockanims:0} run tellraw @s [{"translate": "","color": "gray"},{"translate": "ⓘ ","hover_event":{"action":"show_text","value":[{"translate":"Adds new and more interesting block particles/animations for Enchantment Tables, Dragon Eggs, Beacons, Wither Skeleton Skulls, Jukeboxes and Brewing Stands"},{"text":"\n\nExtra Config IDs: blockanims_jukebox, blockanims_jukebox2, blockanims_jukebox3, blockanims_beacon, blockanims_witherskull, blockanims_brewing, blockanims_enchant, blockanims_dragonegg",color:"gray"}]}},{"translate":"Improved Block Animations: ","color":"gray"},{"translate":"Disabled","color":"red","underlined":true,"hover_event":{"action":"show_text","value":[{"translate":"Click to change this setting"}]},"click_event":{"action":"run_command","command":"/function vanilla_refresh:other/actions/block/blockanims_enable"}}]

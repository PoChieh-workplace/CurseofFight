...
#disc
execute if data storage vanilla_refresh_config:config config{blockanims:1} unless data storage vanilla_refresh_config:config config{blockanims_jukebox:0} as @s[advancements={vanilla_refresh:place/disc=true}] anchored eyes positioned ^ ^ ^ run function vanilla_refresh:block/block_anims/jukebox/raycast

...
execute unless score @s gu.uuid.0 matches -2147483648.. run function senti:zprivate/container/register/zzz/store_uuid
...
function senti:zprivate/container/register/zzz/get_hexes with storage gu:temp
function senti:zprivate/container/register/zzz/concat_uuid with storage gu:temp
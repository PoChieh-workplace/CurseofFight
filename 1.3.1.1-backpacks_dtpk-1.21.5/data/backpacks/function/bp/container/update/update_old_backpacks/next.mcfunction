...
execute if score $temp_slot_update_old_item backpacks.slots matches 0..26 run function backpacks:bp/container/update/update_old_backpacks/check with storage backpacks:temp
